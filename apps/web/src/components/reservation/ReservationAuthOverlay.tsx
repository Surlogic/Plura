...
export default function ReservationAuthOverlay({
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center px-4 py-6">
      ...
      <Card
        tone="default"
        className="relative z-[1] w-full max-w-[720px] overflow-hidden rounded-[34px] border-white/80 bg-white/97 shadow-[0_36px_96px_-48px_rgba(15,23,42,0.38)]"
      >
        <div className="px-6 py-7 sm:px-7 lg:px-10 lg:py-9">
          <div className="mx-auto max-w-[560px]">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <h3 className="mt-2 text-2xl font-semibold text-[color:var(--ink)] sm:text-[2rem]">
