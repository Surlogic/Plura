...
export default memo(function UnifiedSearchBar({
  ...
  const submitButtonToneClassName = isDarkTheme
    ...
    : 'border border-[color:var(--primary)] bg-[color:var(--primary)] text-[color:var(--ink)] shadow-[var(--shadow-card)] hover:-translate-y-0.5 hover:border-[color:var(--primary-strong)] hover:bg-[color:var(--primary-strong)]';
