...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(1100px_620px_at_95%_-10%,rgba(201,170,130,0.18),transparent_55%),linear-gradient(180deg,#fdf9f4_0%,#f5f1eb_100%)] text-[color:var(--ink)]">
