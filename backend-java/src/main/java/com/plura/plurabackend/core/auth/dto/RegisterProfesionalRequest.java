...
public class RegisterProfesionalRequest {
    ...
    /** Ciudad donde opera el negocio cuando atiende con local. */
    @Size(max = 120)
    private String city;

    /** Dirección completa del negocio cuando atiende con local. */
    @Size(max = 255)
    private String fullAddress;

    /** Ubicación completa geocodificada cuando atiende con local. */
    @Size(max = 255)
    ...
    /** Modalidad de atención: LOCAL, A_DOMICILIO o SIN_LOCAL. */
    @NotBlank
