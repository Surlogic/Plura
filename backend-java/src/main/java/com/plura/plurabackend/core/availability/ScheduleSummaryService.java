...
public class ScheduleSummaryService {
    ...
    public void rebuildProfessionalSummary(Long professionalId) {
        ...
        try {
            ...
            boolean hasToday = nextAvailable
                ...
                .orElse(false);
            professionalAvailabilityGateway.updateAvailabilitySummary(
                professionalId,
                hasToday,
    ...
    public void rebuildAllIncremental(int pageSize) {
        ...
        int page = 0;
        while (true) {
            List<Long> professionalIds = professionalAvailabilityGateway.findActiveProfessionalIdsPage(page, size);
    ...
    public void refreshNullRatioGauge() {
        ...
        long withoutNextAvailable = professionalAvailabilityGateway.countActiveProfessionalsWithNextAvailableAtNull();
