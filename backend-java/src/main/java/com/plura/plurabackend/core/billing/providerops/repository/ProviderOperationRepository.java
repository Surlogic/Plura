package com.plura.plurabackend.core.billing.providerops.repository;
...
/**
 * ProviderOperationRepository es un contrato interno del modulo billing / operaciones de proveedor / persistencia.
