...
/**
 * ClientAppFeedbackController es un controlador REST del modulo feedback / controladores.
 * Responsabilidad: recibir requests HTTP, validar acceso basico y delegar la operacion al servicio de aplicacion o dominio.
 * Superficie HTTP: atiende rutas bajo /cliente/app-feedback y deja la logica pesada en servicios.
 * Foco funcional: feedback, clientes.
 */
@RestController
