...
public class BillingNotificationCommandFactory {
    ...
    public NotificationRecordCommand buildPaymentApproved(
        ...
        return buildCommand(
            ...
            new NotificationInAppProjectionCommand(
                "Pago aprobado",
                "Se aprobó un pago asociado a la reserva de " + serviceLabel(booking) + ".",
                NotificationSeverity.SUCCESS,
                "PAYMENT",
                actionUrl(booking),
                "Ver reserva"
            ),
            emailProjection(recipient, "professional_payment_approved", "Pago aprobado", payload)
        );
    }
    ...
    public NotificationRecordCommand buildPaymentFailed(
        ...
        return buildCommand(
            ...
            new NotificationInAppProjectionCommand(
                "Pago fallido",
                "Falló un pago asociado a la reserva de " + serviceLabel(booking) + ".",
                NotificationSeverity.ERROR,
                "PAYMENT",
                actionUrl(booking),
                "Ver reserva"
            ),
            emailProjection(recipient, "professional_payment_failed", "Pago fallido", payload)
        );
    }
    ...
    public NotificationRecordCommand buildPaymentRefunded(
        ...
        return buildCommand(
            ...
            new NotificationInAppProjectionCommand(
                ...
                "Se registró un reembolso asociado a la reserva de " + serviceLabel(booking) + ".",
                NotificationSeverity.INFO,
                "PAYMENT",
                actionUrl(booking),
                "Ver reserva"
            ),
            emailProjection(recipient, "professional_payment_refunded", "Reembolso registrado", payload)
        );
    }
    ...
    public NotificationRecordCommand buildPaymentRefundPending(
        ...
        return buildCommand(
            ...
            new NotificationInAppProjectionCommand(
                ...
                "Se inició una devolución asociada a la reserva de " + serviceLabel(booking) + ". La acreditación depende de Mercado Pago.",
                NotificationSeverity.INFO,
                "PAYMENT",
                actionUrl(booking),
                "Ver reserva"
            ),
            emailProjection(recipient, "professional_payment_refund_pending", "Reembolso en proceso", payload)
        );
    }
