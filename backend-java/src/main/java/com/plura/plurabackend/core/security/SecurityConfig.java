    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.DELETE, "/auth/client-profile").hasAnyRole("PROFESSIONAL", "USER")
                ...
                .requestMatchers("/auth/me/cliente").hasAnyRole("PROFESSIONAL", "USER")
                .requestMatchers("/auth/me", "/auth/contexts", "/auth/context/select").hasAnyRole("PROFESSIONAL", "USER", "WORKER")
                .requestMatchers("/auth/sessions", "/auth/sessions/**", "/auth/logout-all", "/auth/audit").hasAnyRole("PROFESSIONAL", "USER", "WORKER")
