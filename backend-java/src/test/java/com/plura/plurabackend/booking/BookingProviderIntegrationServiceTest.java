...
import com.plura.plurabackend.billing.providerops.ProviderOperationService;
...
class BookingProviderIntegrationServiceTest {
    ...
    void shouldReusePendingCheckoutSessionInsteadOfCreatingAnotherChargeAttempt() throws Exception {
        ...
        pendingCharge.setProfessional(booking.getProfessional());
    ...
    void shouldPreferLatestPendingChargeAttemptWhenMultiplePendingTransactionsExist() throws Exception {
        ...
        olderPending.setProfessional(booking.getProfessional());
        ...
        latestPending.setProfessional(booking.getProfessional());
    ...
    void shouldAutoConfirmPendingPrepaidBookingWhenChargeWebhookSucceeds() {
        ...
        charge.setProfessional(booking.getProfessional());
    ...
    void shouldSendSplitCodeWhenCreatingBookingCheckout() {
        ...
        User user = clientUser();
        Booking booking = prepaidBooking();
        booking.getProfessional().setDlocalSplitCode("seller-contract-001");
    ...
    void shouldSettlePayoutInternallyWhenChargeUsedSplitPayments() throws Exception {
        ...
        var payoutRecord = new com.plura.plurabackend.booking.finance.model.BookingPayoutRecord();
        ...
        payoutRecord.setStatus(com.plura.plurabackend.booking.finance.model.BookingPayoutStatus.PENDING_MANUAL);
        ...
        var completedRecord = new com.plura.plurabackend.booking.finance.model.BookingPayoutRecord();
        completedRecord.setId("payout-1");
        completedRecord.setBooking(booking);
        completedRecord.setProfessional(booking.getProfessional());
        ...
        completedRecord.setStatus(com.plura.plurabackend.booking.finance.model.BookingPayoutStatus.COMPLETED);
        ...
        var result = service.processPostDecision(
            booking,
            new com.plura.plurabackend.booking.finance.BookingFinanceUpdateResult(
