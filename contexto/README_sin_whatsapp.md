...
- en el paso final de `/reservar`, si el cliente todavia no tiene sesion, la web ahora abre primero una pantalla embebida de registro/login para completar el acceso sin salir del flujo; `pendingReservation` se conserva como respaldo si el usuario termina en las pantallas completas de auth
