...
- cuando el refund queda iniciado pero pendiente de acreditacion, backend registra `PAYMENT_REFUND_PENDING` solo para el cliente, lo refleja en inbox/timeline cliente y genera email transaccional con leyenda de tiempos de Mercado Pago
