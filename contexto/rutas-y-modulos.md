...
- `/profesional/auth/register`: el botón de Google del wizard profesional usa OAuth en la misma pestaña (`mode="redirect"`), vuelve por `/oauth/callback` y continúa el mismo wizard sin popup. El teléfono sigue siendo obligatorio como dato de contacto dentro del paso de datos básicos.
