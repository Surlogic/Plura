...
- `PublicReviewsList` resuelve el cierre `Confianza`: layout de dos columnas con rating, reseña destacada cuando existe, modal paginado para ver todas y mapa/ubicación con CTA `Cómo llegar`; sigue respetando ocultamiento del texto publico
