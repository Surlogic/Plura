...
- en `/explorar?vista=mapa`, el mapa prioriza `Mapbox GL` cuando WebGL esta disponible y cae a un fallback interactivo con Leaflet/OpenStreetMap cuando ese navegador no puede inicializar WebGL; la columna izquierda mantiene scroll propio y el mapa sigue siendo draggable/clickeable
