...
- `/login` sin intent muestra selector cuando la cuenta tiene varios contextos; `/login?intent=client` y `/login?intent=professional` seleccionan ese contexto automaticamente si existe y el contexto queda persistido en el access token.
