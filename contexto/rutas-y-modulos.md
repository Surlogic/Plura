...
- `components/profesional/public-page/PublicServicesSection.tsx`: lista compacta de servicios con pills por categoria, metadata breve, mas ancho horizontal y CTA directo hacia el flujo dedicado de reserva.
